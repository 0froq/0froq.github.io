...
import GhostPresenceRail from './components/stats/GhostPresenceRail.vue'
import GhostPeekToasts from './components/stats/GhostPeekToasts.vue'
...
const showGhostPresence = computed(() => isGhostPresencePath(route.path))
...
<template>
  ...
  >
    ...
    />
    <ClientOnly>
      <GhostPresenceRail v-if="showGhostPresence" />
      <GhostPeekToasts />
      <AnnotationClient />
      <VisitorNotesClient />
      <StatsSessionClient />
