---
title: Carve：Capture 不是入口，而是隔离舱
created: 2026-06-18
status: probe
aigc: true
...
我先检查了最近几篇 Carve / Continuation 的反馈区。最近几篇没有 froQ
新增的判断、反例或继续标记，所以这轮没有生成 Continuation。

主轨里，近两天 Git 变化很大，但多数是 Corpus 结构迁移、旧 Carve
...
本轮没有发现可展开的 froQ 反馈，所以未生成 Continuation。Carve 方向来自
