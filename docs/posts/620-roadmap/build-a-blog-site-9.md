...
status: form
last_modified: 2026-04-24 16:47:57
---
...
我们在 [之前的文章](build-a-blog-site-6.md#改一点结构) 中
为文件文章页面添加了标题。
对于一个成熟的博客网站而言，
我们需要更多的信息，
比如创建时间、
...
![看看效果](build-a-blog-site-9-assets/ATTCH-20250703112116.png)
...
![简单分类和简单样式](build-a-blog-site-9-assets/ATTCH-20250703115239.png)
