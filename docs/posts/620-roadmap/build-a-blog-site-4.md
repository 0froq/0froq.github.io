...
status: form
last_modified: 2026-04-24 16:50:18
---
...
在 [这个系列的第二篇文章](build-a-blog-site-2.md) 中，
我们已经实现了尊重用户偏好模式的同时，
支持手动切换的黑暗模式功能。
进行手动切换的按钮是一个很简单的按钮，
没有什么特殊的样式。
...
如果您使用 JS，
可以直接跳过至 [模板中的处理](build-a-blog-site-4#模板中的处理)。
...
![太阳和月亮](build-a-blog-site-4-assets/ATTCH-20250821115215.png)
